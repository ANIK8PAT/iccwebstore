        ...
        <div class="app">
            <div class="header">
                <div class="header-menu">
                    <a class="menu-link is-active" href="index.php">Books</a>
                    <a class="menu-link" href="addnew.php">Add New</a>
                </div>
                        ...
                        <div class="content-wrapper-header">
                            <div class="content-wrapper-context">
                                <h3 class="img-content">
                                    <img src="logo.jpg" width="24px" height="24px" class="logo">
                                      ICC Bookstore
                                </h3>
                                <div class="content-text">Text about ICC Bookstore.</div>
                                <button class="content-button">Buy Now</button>
                            </div>
                            <img class="content-wrapper-img" src="glass4.png">
                        </div>
                        <div class="content-section">
                            <div class="content-section-title">Bestsellers</div>
                            <ul>
                                <li class="bestseller-book">
...
<path d="M1360 1600 l0 -80 400 0 400 0 0 80 0 80 -400 0 -400 0 0 -80z"/>
                                    ...
                                    <div class="button-wrapper">
                                        <button class="content-button author-button buy">Buy</button>
                                        <div class="menu">
...
<path fill="#fff" d="M60.092,118c0,0,12.091-17.425,32.153-17.425c18.382,0,27.938,5.343,27.938,5.343v-8.893
	c0,0-9.556-5.341-27.938-5.466c-20.062-0.136-32.153,17.548-32.153,17.548V118z"/>
                        ...
                        <div class="content-section">
                            <div class="content-section-title">All Books</div>
                            <div class="books-card">
                                <div class="book-card">
                                    <div class="book">
                                        <div class="book-image">
                                            <img src="./resources/itendswithus.jpg"></div>
                                        <div class="book-detail">
                                            <span class="book-name">
                                            It Ends With Us
                                            </span>
                                            <div class="book-card-author">Colleen Hoover</div>
                                        </div>
                                    </div>
